...
import com.company.taskmanager.impl.StubbornTaskManager;
...
public class TestStubbornTaskManager {
    ...
    public void testAdd() throws TerminationError{
        ...
        assertEquals(5, tm.list(SortType.ID).get(4).getId());
